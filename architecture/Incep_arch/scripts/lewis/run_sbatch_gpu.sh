...
output_dir=$gloable_dir/architecture/outputs/Incep_arch/all_dataset
acclog_dir=$gloable_dir/architecture/outputs/All_Validation_Acc
printf "$gloable_dir\n"

python $gloable_dir/architecture/Incep_arch/scripts/train_deepIncep.py 150 32 5 'nadam' 4 50 1  $feature_dir $output_dir $acclog_dir 5
