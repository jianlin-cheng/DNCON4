...
# sample120:train120,test40
# sample500:train500,test60
dist_string = '80'
if sysflag == 'local':
	path_of_lists = os.path.dirname(GLOBAL_PATH)+'/data/badri_training_benchmark/lists-test-train_sample120_r5/'
