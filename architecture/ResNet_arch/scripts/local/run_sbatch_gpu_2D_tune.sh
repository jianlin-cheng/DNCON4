...
# python $gloable_dir/architecture/ResNet_arch/scripts/train_deepResNet_2D_gen_tune_cov.py 150 64 6 'nadam' 3  50 1 $feature_dir $output_dir $acclog_dir 1 'he_normal' 'binary_crossentropy' 14

python $gloable_dir/architecture/ResNet_arch/scripts/train_deepResNet_2D_gen_tune.py 150 28 6 'nadam' 3  50 1 $feature_dir $output_dir $acclog_dir 1 'VarianceScaling' 'binary_crossentropy' 17
