...
gloable_dir=/storage/htc/bdm/jh7x3/DNCON4/development_packages/DNCON4_packages_20190226/
# feature_dir=$gloable_dir/data/badri_training_benchmark/feats/
feature_dir=/storage/htc/bdm/Collaboration/Zhiye/DNCON4/data/deepcov/feats/ 
output_dir=$gloable_dir/architecture/outputs/ResNet_arch/newmaxout_3500
acclog_dir=$gloable_dir/architecture/outputs/All_Validation_Acc
printf "$gloable_dir\n"


python $gloable_dir/architecture/ResNet_arch/scripts/train_deepResNet_2D_gen_tune_cov.py 150 64 6 'nadam' 3  50 1 $feature_dir $output_dir $acclog_dir 1 'he_normal' 'binary_crossentropy' 1
