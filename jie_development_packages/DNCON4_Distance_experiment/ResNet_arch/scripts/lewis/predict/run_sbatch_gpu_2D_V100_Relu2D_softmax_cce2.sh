...
#  SBATCH CONFIG
#--------------------------------------------------------------------------------
#SBATCH --job-name=RN-sCCE2         # name for the job
#SBATCH -o ResNet-sCCE2-%j.out
...
output_dir=/scratch/jh7x3/DNCON4/jie_development_packages/DNCON4_Distance_experiment/Test/Distance_Relu2D_softmax_cce2
acclog_dir=/scratch/jh7x3/DNCON4/jie_development_packages/DNCON4_Distance_experiment/Test/Distance_Relu2D_softmax_cce2
printf "$gloable_dir\n"
...
python /scratch/jh7x3/DNCON4/jie_development_packages/DNCON4_Distance_experiment/ResNet_arch/scripts/train_deepResNet_2D_gen_tune.py 150 64 6 'nadam' 3  40 1 $feature_dir $output_dir $acclog_dir 1 'he_normal' 'categorical_crossentropy' 1
