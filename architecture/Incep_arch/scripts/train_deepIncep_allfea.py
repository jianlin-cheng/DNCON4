...
import time
data_all_dict_padding = load_train_test_data_padding_with_interval(train_datafile, feature_dir,inter,5000,0,dist_string)
testdata_all_dict_padding = load_train_test_data_padding_with_interval(val_datafile, feature_dir, inter,5000,0,dist_string)


start_time = time.time()
DNCON4_1d2dconv_train_win_filter_layer_opt_fast(data_all_dict_padding,testdata_all_dict_padding,CV_dir, feature_dir,"DNCON4_1d2dINCEP",out_epoch,in_epoch,inter,5000,filetsize_array,True,'sigmoid',nb_filters,nb_layers,opt,lib_dir, batchsize,path_of_lists,path_of_Y, path_of_X,Maximum_length,dist_string)
