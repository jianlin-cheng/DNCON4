...
###### set custom GLOBAL_PATH and DATA_PATH #########
GLOBAL_PATH='/storage/htc/bdm/jh7x3/DNCON4/development_packages/DNCON4_packages_20190226'
DATA_PATH='/storage/htc/bdm/Collaboration/Zhiye/DNCON4/'
#####################################################
...
dist_string = '80'
if sysflag == 'local':
  path_of_lists = os.path.dirname(DATA_PATH)+'/data/badri_training_benchmark/lists-test-train/'
  ...
  path_of_lists = os.path.dirname(DATA_PATH)+'/data/deepcov/lists-test-train/'
  reject_fea_file =  GLOBAL_PATH+'/lib/feature_to_use_cov.txt'
path_of_Y         =  feature_dir + '/bin_class/' ### set to output type
