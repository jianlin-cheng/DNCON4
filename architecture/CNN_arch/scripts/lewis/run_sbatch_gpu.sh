...
output_dir=$gloable_dir/architecture/outputs/CNN_arch/newmaxout
...
python $gloable_dir/architecture/CNN_arch/scripts/train_deepCNN_2D_gen_tune.py 150 64 2 'nadam' 5  40 1  $feature_dir $output_dir $acclog_dir 3 "glorot_uniform" "binary_crossentropy" 2 "relu"
