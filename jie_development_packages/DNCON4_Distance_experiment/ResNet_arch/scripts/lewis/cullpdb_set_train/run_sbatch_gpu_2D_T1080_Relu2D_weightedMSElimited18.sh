...
#SBATCH -o ResNet-wMSEli18-cullpdb-T1080-%j.out
...
output_dir=/scratch/jh7x3/DNCON4/jie_development_packages/DNCON4_Distance_experiment/Test/cullpdb_Distance_Relu2D_weighted_MSElimited18_inloop
acclog_dir=/scratch/jh7x3/DNCON4/jie_development_packages/DNCON4_Distance_experiment/Test/cullpdb_Distance_Relu2D_weighted_MSElimited18_inloop
printf "$gloable_dir\n"
...
python /scratch/jh7x3/DNCON4/jie_development_packages/DNCON4_Distance_experiment/ResNet_arch/scripts/train_deepResNet_2D_gen_tune_cullpdb.py 150 64 6 'nadam' 3  100 1 $feature_dir $output_dir $acclog_dir 1 'he_normal' 'weighted_MSE_limited3' 1
