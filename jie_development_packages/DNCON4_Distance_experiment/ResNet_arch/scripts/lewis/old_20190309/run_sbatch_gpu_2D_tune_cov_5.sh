...
output_dir=$gloable_dir/architecture/outputs/ResNet_arch/cov_dncon2
...
python $gloable_dir/architecture/ResNet_arch/scripts/train_deepResNet_2D_gen_tune.py 150 28  6 'nadam' 3  50 1 $feature_dir $output_dir $acclog_dir 3 'VarianceScaling' 'weighted_crossentropy' 5
