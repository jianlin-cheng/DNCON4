...
#  SBATCH CONFIG
#--------------------------------------------------------------------------------
#SBATCH --job-name=RN-MSE-l         # name for the job
#SBATCH -o ResNet-MSE-limited100-%j.out
...
output_dir=/scratch/jh7x3/DNCON4/jie_development_packages/DNCON4_Distance_experiment/Test/dncon2_Distance_Relu2D_MSE_limited100
acclog_dir=/scratch/jh7x3/DNCON4/jie_development_packages/DNCON4_Distance_experiment/Test/dncon2_Distance_Relu2D_MSE_limited100
printf "$gloable_dir\n"
...
python /scratch/jh7x3/DNCON4/jie_development_packages/DNCON4_Distance_experiment/ResNet_arch/scripts/train_deepResNet_2D_gen_tune.py 150 64 6 'nadam' 3  100 1 $feature_dir $output_dir $acclog_dir 1 'he_normal' 'MSE_limited' 1
