...
python $gloable_dir/architecture/Incep_arch/scripts/train_deepIncep_2D_gen_tune.py 150 32 6 'nadam' 3 45 1  $feature_dir $output_dir $acclog_dir 1 "glorot_uniform" "binary_crossentropy" 1s
