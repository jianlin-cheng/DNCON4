...
for i in range(0,L):
   for j in range(i+1,L):
       f.write(str(i+1)+" "+str(j+1)+" "+str(cmap[i][j])+"\n")
f.close()
subprocess.call("perl /scratch/jh7x3/DNCON4/jie_development_packages/DNCON4_Distance_experiment/lib/sort_dist.pl  "+rr_file+".raw  "+ rr_file+".raw.sorted",shell=True)
